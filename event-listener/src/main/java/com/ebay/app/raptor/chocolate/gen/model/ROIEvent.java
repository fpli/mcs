...
@javax.annotation.Generated(value = "com.ebay.swagger.templates.codegen.JavaEtsGenerator", date = "2020-03-09T19:03:24.098+08:00[Asia/Shanghai]")
...
public class ROIEvent implements Serializable {
   ...
   * @return payload
   **/
  @ApiModelProperty(example = "{“transactionTimestamp”:”aaa”,“siteId”:”bbb”}", value = "")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transType, uniqueTransactionId, itemId, payload);
  }
