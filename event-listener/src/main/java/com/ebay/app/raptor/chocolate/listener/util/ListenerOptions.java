...
public class ListenerOptions extends AbstractApplicationOptions implements KafkaSink.KafkaConfigurable {
  ...
  public int getInputHttpPort() {
    return ApplicationOptionsParser.getNumericProperty(properties, INPUT_HTTP_PORT, 8000, 9000);
  }

  public int getInputHttpsPort() {
    return ApplicationOptionsParser.getNumericProperty(properties, INPUT_HTTPS_PORT, 8000, 9000);
  }

  public int getOutputHttpPort() {
    return ApplicationOptionsParser.getNumericProperty(properties, OUTPUT_HTTP_PORT, 80, 9000);
  }

  public int getOutputHttpsPort() {
    return ApplicationOptionsParser.getNumericProperty(properties, OUTPUT_HTTPS_PORT, 443, 9000);
  }
  ...
  public int getMaxThreads() {
    return ApplicationOptionsParser.getNumericProperty(properties, MAX_THREADS, 50, 500);
  }

  public File getPidFile() throws IOException {
    return ApplicationOptionsParser.getFile(properties, PID_FILE, false, null, false);
  }
}
