...
public class CustomizedSchemeRequestHandlerTest {
    ...
    public void testCustomizedSchemeRequestHandler() {
        ...
        event = customizedSchemeRequestHandler.parseCustomizedSchemeEvent(targetURL, referer);
        assertEquals("https://www.ebay.co.uk/itm/154347659933?mkevt=1&mkcid=1&mkrid=710-53481-19255-0&campid=5337369893&toolid=11800&customid=test&ul_ref=https%3A%2F%2Frover.ebay.com%2Frover%2F1%2F711-53200-19255-0%2F1", event.getTargetUrl());
        assertEquals(referer, event.getReferrer());
