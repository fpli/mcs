...
import com.ebay.traffic.chocolate.flink.nrt.parquet.generated.Address;
...
public class ParquetStreamingFileSinkITCase extends AbstractTestBase {
	...
	public void testWriteParquetAvroSpecific() throws Exception {
		...
		stream.addSink(
				StreamingFileSink.forBulkFormat(
						...
						CompressionParquetAvroWriters.forSpecificRecord(Address.class, CompressionCodecName.SNAPPY))
				.build());
	...
	public void testWriteParquetAvroGeneric() throws Exception {
		...
		stream.addSink(
				StreamingFileSink.forBulkFormat(
						Path.fromLocalFile(folder),
						CompressionParquetAvroWriters.forGenericRecord(schema, CompressionCodecName.SNAPPY))
						.build());
	...
	public void testWriteParquetAvroReflect() throws Exception {
		...
		stream.addSink(
				StreamingFileSink.forBulkFormat(
						Path.fromLocalFile(folder),
						CompressionParquetAvroWriters.forReflectRecord(Datum.class, CompressionCodecName.SNAPPY))
						.build());
