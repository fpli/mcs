...
public class UtpMonitorTest {
    @Test
    public void getDomainFromURL() {
        //test case 1: url is null or empty
        String urlquerystring = "";
        assertEquals(null, UtpMonitor.getDomainFromUrl(urlquerystring));
        ...
        assertEquals("www.ebay.com", UtpMonitor.getDomainFromUrl(urlquerystring));
    ...
    public void getPageType(){
        String url = "";
        //test case 1: url is null or empty
        assertEquals(null, UtpMonitor.getPageType(url));
        url = null;
        assertEquals(null, UtpMonitor.getPageType(url));
        ...
        assertEquals("i", UtpMonitor.getPageType(url));
        ...
        assertEquals("itm", UtpMonitor.getPageType(url));
        ...
        assertEquals("sch", UtpMonitor.getPageType(url));
        ...
        assertEquals("b", UtpMonitor.getPageType(url));
        ...
        assertEquals("e", UtpMonitor.getPageType(url));
        ...
        assertEquals("vod", UtpMonitor.getPageType(url));
        ...
        assertEquals("ulk", UtpMonitor.getPageType(url));
        ...
        assertEquals("ws", UtpMonitor.getPageType(url));
        ...
        assertEquals("p", UtpMonitor.getPageType(url));
        ...
        assertEquals("homepage", UtpMonitor.getPageType(url));
        ...
        assertEquals("others", UtpMonitor.getPageType(url));
        ...
        assertEquals("cnt", UtpMonitor.getPageType(url));
        ...
        assertEquals("sl", UtpMonitor.getPageType(url));
        ...
        assertEquals("signin", UtpMonitor.getPageType(url));
        ...
        assertEquals("fdbk", UtpMonitor.getPageType(url));
        ...
        assertEquals("rtn", UtpMonitor.getPageType(url));
    ...
    public void getUFESSignal(){
        ...
        assertEquals("NULL", UtpMonitor.getUFESSignal(payload));

        //test case 2: isUfes = true
        payload.put("isUfes", "true");
        assertEquals("true", UtpMonitor.getUFESSignal(payload));

        //test case 3: isUfes = false
        payload.put("isUfes", "false");
        assertEquals("false", UtpMonitor.getUFESSignal(payload));
    ...
    public void testHomepagePattern(){
        ...
        assertEquals(true, UtpMonitor.isHomepageDomain(domain));

        domain = "ww1.ebay.com";
        assertEquals(false, UtpMonitor.isHomepageDomain(domain));
