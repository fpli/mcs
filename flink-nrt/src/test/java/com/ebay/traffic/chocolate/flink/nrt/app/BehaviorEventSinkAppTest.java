...
public class BehaviorEventSinkAppTest {
  ...
  public void getSinkBasePath() {
    assertEquals(new Path("temp/unified_tracking/tracking_event"), behaviorEventSinkApp.getSinkBasePath());
  }
  ...
  public void transformRichMapFunction() throws Exception {
    ...
    assertEquals("ext=56623&bu=43551630917&euid=c527526a795a414cb4ad11bfaba21b5d&emsid=e11051.m44.l1139" +
                    "&emid=43551630917",
  ...
  public void getKafkaConsumer() {
    FlinkKafkaConsumer<ConsumerRecord<byte[], byte[]>> kafkaConsumer = behaviorEventSinkApp.getKafkaConsumer();
  ...
  public void getStreamingFileSink() {
    StreamingFileSink<BehaviorEvent> streamingFileSink = behaviorEventSinkApp.getStreamingFileSink();
