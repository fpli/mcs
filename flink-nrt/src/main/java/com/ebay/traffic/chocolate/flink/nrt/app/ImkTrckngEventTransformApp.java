...
public class ImkTrckngEventTransformApp
  ...
  protected DataStream<Tuple3<String, Long, byte[]>> transform(DataStreamSource<ConsumerRecord<byte[], byte[]>> dataStreamSource) {
    SingleOutputStreamOperator<FilterMessageV7> filterMessageStream = dataStreamSource.map(new DecodeFilterMessageFunction());
    SingleOutputStreamOperator<FilterMessageV7> resultStream = filterMessageStream.filter(new FilterEbaySites());
  ...
  protected static class DecodeFilterMessageFunction
          extends ESMetricsCompatibleRichMapFunction<ConsumerRecord<byte[], byte[]>, FilterMessageV7> {
  ...
  protected static class TransformFunction
      extends ESMetricsCompatibleRichMapFunction<FilterMessageV7, Tuple3<String, Long, byte[]>> {
    ...
    @Override
    public Tuple3<String, Long, byte[]> map(FilterMessageV7 filterMessage) throws Exception {
  ...
  protected static class FilterEbaySites extends RichFilterFunction<FilterMessageV7> {
    ...
    @Override
    public boolean filter(FilterMessageV7 value) throws Exception {
      recordCounter.inc();
    ...
    private String getPageType(FilterMessageV7 value) {
