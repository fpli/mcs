...
import com.ebay.traffic.chocolate.flink.nrt.ParquetAvroWriters;
...
public class ImkRvrTrckngEventSinkApp extends BaseRheosHDFSCompatibleApp<ConsumerRecord<byte[], byte[]>, ImkRvrTrckngEventMessage> {
