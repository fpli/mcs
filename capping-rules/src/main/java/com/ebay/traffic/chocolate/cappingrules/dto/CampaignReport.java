...
@Table(keyspace = REPORT_KEYSPACE, name = CAMPAIGN_REPORT_CF)
public class CampaignReport {
  @PartitionKey(value = 0)
  @Column(name = CAMPAIGN_ID_COLUMN)
  ...
  public CampaignReport(RawReportRecord record) {
  ...
  public boolean equals(Object obj) {
    ...
    CampaignReport reportRecord = (CampaignReport) obj;
    return ((this.campaignId == reportRecord.campaignId) && this.snapshotId == reportRecord.getSnapshotId());
  }
}
