...
public class DistCpConstants {
  ...
  public static final String CONF_LABEL_COPY_FROM_INSECURE_TO_SECURE = "distcp.chocolate.copy.from.insecure.to.secure";
  public static final String CONF_LABEL_TARGET_PRINC = "distcp.chocolate.target.princ";
  public static final String CONF_LABEL_TARGET_KEYTAB = "distcp.chocolate.target.keytab";
  public static final String DEFAULT_TARGET_CORE_SITE_XML = "core-site-target.xml";
  public static final String DEFAULT_TARGET_HDFS_SITE_XML = "hdfs-site-target.xml";
