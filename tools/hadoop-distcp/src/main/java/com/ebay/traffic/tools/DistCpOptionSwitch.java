...
public enum DistCpOptionSwitch {
  ...
  /**
   * Below options are specific to Chocolate. Target Principal and keytab are
   * only used when -copyFromInsecureToSecure is specified on command line.
   */
  COPY_FROM_INSECURE_TO_SECURE(DistCpConstants.CONF_LABEL_COPY_FROM_INSECURE_TO_SECURE,
          new Option("copyFromInsecureToSecure", false, "(Specific to Chocolate) Whether to copy from insecure cluster to secure cluster")),

  TARGET_PRINCIPAL(DistCpConstants.CONF_LABEL_TARGET_PRINC,
          new Option("targetprinc", true, "(Specific to Chocolate) When -fromInsecureToSecure is set, specify Kerberos principal for target")),

  TARGET_KEYTAB(DistCpConstants.CONF_LABEL_TARGET_KEYTAB,
          new Option("targetkeytab", true, "(Specific to Chocolate) When -fromInsecureToSecure is set, specify Kerberos keytab for target"));
