...
package com.ebay.traffic.tools;

import com.ebay.traffic.tools.util.DistCpUtils;
...
public class DistCpOptions {
  ...
  private boolean copyFromInsecureToSecure = false;
  private String targetPrinc;
  private String targetKeytab;
  ...
  public DistCpOptions(DistCpOptions that) {
    if (this != that && that != null) {
      ...
      this.copyFromInsecureToSecure = that.copyFromInsecureToSecure;
      this.targetPrinc = that.targetPrinc;
      this.targetKeytab = that.targetKeytab;
    }
  }
  ...
  public void setCopyFromInsecureToSecure(boolean copyFromInsecureToSecure, String targetPrinc, String targetKeytab) {
    validate(DistCpOptionSwitch.COPY_FROM_INSECURE_TO_SECURE, copyFromInsecureToSecure);
    this.copyFromInsecureToSecure = copyFromInsecureToSecure;
    this.targetPrinc = targetPrinc;
    this.targetKeytab = targetKeytab;
  }

  public boolean getCopyFromInsecureToSecure() { return this.copyFromInsecureToSecure; }
  ...
  public void validate(DistCpOptionSwitch option, boolean value) {
    ...
    boolean copyFromInsecureToSecure = (option == DistCpOptionSwitch.COPY_FROM_INSECURE_TO_SECURE ?
            value : this.copyFromInsecureToSecure);
    ...
    if (useDiff && copyFromInsecureToSecure) {
      throw new IllegalArgumentException(
              "Diff is disallowed when copying from insecure to secure cluster");
    }
  }
  ...
  public void appendToConf(Configuration conf) {
    ...
    // Specific to Chocolate
    DistCpOptionSwitch.addToConf(conf, DistCpOptionSwitch.COPY_FROM_INSECURE_TO_SECURE,
            String.valueOf(copyFromInsecureToSecure));
    if (this.targetPrinc != null) {
      DistCpOptionSwitch.addToConf(conf, DistCpOptionSwitch.TARGET_PRINCIPAL, this.targetPrinc);
    }
    if (this.targetKeytab != null) {
      DistCpOptionSwitch.addToConf(conf, DistCpOptionSwitch.TARGET_KEYTAB, this.targetKeytab);
    }
  }
  ...
  public String toString() {
    return "DistCpOptions{" +
            ...
            ", copyFromInsecureToSecure='" + copyFromInsecureToSecure + '\'' +
            ", targetprinc='" + targetPrinc + '\'' +
            ", targetkeytab='" + targetKeytab + '\'' +
            '}';
  }
