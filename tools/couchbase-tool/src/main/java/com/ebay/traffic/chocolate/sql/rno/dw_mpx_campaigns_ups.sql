...
msck repair table choco_data.dw_mpx_campaigns_ups;
...
from choco_data.dw_mpx_campaigns_ups
) origin
where origin.row_number = 1;


insert overwrite table choco_data.dw_mpx_campaigns_temp
select o.campaign_id,
       ...
       o.upd_date,
       o.upd_user
from choco_data.dw_mpx_campaigns o
left outer join choco_data.dw_mpx_campaigns_ups_distinct u
...
select w.campaign_id,
       ...
       current_timestamp(),
       w.upd_user
from choco_data.dw_mpx_campaigns_ups_distinct w
left outer join choco_data.dw_mpx_campaigns t
...
select caw.campaign_id,
       ...
       current_timestamp(),
       caw.upd_user
from choco_data.dw_mpx_campaigns_ups_distinct caw
left outer join choco_data.dw_mpx_campaigns ca
on caw.campaign_id = ca.campaign_id
where ca.campaign_id is null;


insert overwrite table choco_data.dw_mpx_campaigns
select *
from choco_data.dw_mpx_campaigns_temp;
