...
msck repair table im_tracking.dw_mpx_rotations_ups;


insert overwrite table im_tracking.dw_mpx_rotations_temp
select o.rotation_id,
       ...
       o.UPD_DATE,
       o.UPD_USER
from im_tracking.dw_mpx_rotations o
left outer join im_tracking.dw_mpx_rotations_ups u
on o.rotation_id = u.rotation_id
where u.rotation_id is null;



insert into table im_tracking.dw_mpx_rotations_temp
select ori.rotation_id,
       nvl(ori.placement_id, -999),
       nvl(ori.campaign_id, -999),
       nvl(ori.vendor_id, -999),
       ori.PORTL_BKT_ID,
       ori.PORTL_SUB_BKT_ID,
       ori.PORTL_PRTNR_GRP_ID,
       ...
       ori.PORTL_DSHBRD_FLAG_ID,
       ori.PORTL_INVC_FLAG_ID,
       ori.PORTL_SRC_CRE_DT,
...
select ro.rotation_id,
       ...
       ro.vendor_id,
       rot.PORTL_BKT_ID,
       rot.PORTL_SUB_BKT_ID,
       rot.PORTL_PRTNR_GRP_ID,
       ro.rotation_string,
       ro.rotation_name,
       ro.rotation_cost,
       ro.rotation_count,
       ...
       rot.PORTL_DSHBRD_FLAG_ID,
       rot.PORTL_INVC_FLAG_ID,
       rot.PORTL_SRC_CRE_DT,
       ...
       ro.perf_track_9,
       ro.perf_track_10
from im_tracking.dw_mpx_rotations_ups ro
left outer join im_tracking.dw_mpx_rotations rot
on ro.rotation_id = rot.rotation_id
where rot.rotation_id is not null
) ori
left outer join im_tracking.dw_mpx_rotations_pt_lkp lkp
...
left outer join im_tracking.dw_mpx_rotations roi
on ro.rotation_id = roi.rotation_id
where roi.rotation_id is null;



insert overwrite table im_tracking.V_GBH_FROM_NAME
select rotation_id,
       GBH_TMP,
       GBH_TMP1,
       NEW_GEO_CLIENT_ID
...
from im_tracking.dw_mpx_rotations_temp
) gt
) gtone
) ngci
...
insert overwrite table im_tracking.dw_mpx_rotations_temp_one
select t.rotation_id,
       ...
       t.UPD_DATE,
       t.UPD_USER
from im_tracking.dw_mpx_rotations_temp t
left outer join im_tracking.V_GBH_FROM_NAME v
on t.rotation_id = v.rotation_id;


insert overwrite table im_tracking.dw_mpx_rotations_temp_two
select t.rotation_id,
       t.placement_id,
       t.campaign_id,
       t.vendor_id,
       ...
       t.UPD_DATE,
       t.UPD_USER
from im_tracking.dw_mpx_rotations_temp_one t
where ROTATION_BRAND_IND <> 0;


insert into table im_tracking.dw_mpx_rotations_temp_two
select t.rotation_id,
       t.placement_id,
       t.campaign_id,
       t.vendor_id,
