...
create external table im_tracking.dw_mpx_rotations_pt_lkp (
...
NULL DEFINED AS ""
STORED AS TEXTFILE
LOCATION 'hdfs://hercules/sys/edw/imk/im_tracking/rotation/dw_mpx_rotations_pt_lkp/snapshot';

msck repair table im_tracking.dw_mpx_rotations_pt_lkp;