...
public class DumpRotationFilesTest {
  ...
  public void testDumpFileFromCouchbase() throws IOException {
    ...
    DumpRotationFiles.setBucket(bucket);
    ...
    DumpRotationFiles.setCouchbasePros(couchbasePros);

    // run dump job
    createFolder();
    DumpRotationFiles.dumpFileFromCouchbase("1287554384000", "1603173584000", TEMP_FILE_FOLDER + TEMP_FILE_PREFIX);
