...
public class DailyDoneFileTable {
  ...
  private static String getBodyLine(ArrayList<DoneFile> list) {
    ...
    for (int i = 0; i < list.size(); i++) {
      bodyLine = bodyLine + "<tr><td>" + list.get(i).getDataSource() + "</td>" + getWarnLevel(list.get(i).getStatus()) + "<td>" + list.get(i).getCurrentDoneFile() + "</td><td>" + list.get(i).getClusterName() + "</td></tr>";
    }
  ...
  private static String getHeader() {
    return "<table border='1'><tr width=\"350\" bgcolor=\"#8A8A8A\"><th width=\"300\">data source</th><th width=\"300\">status</th><th width=\"300\">current done file</th><th width=\"300\">cluster name</th></tr>";
  }
