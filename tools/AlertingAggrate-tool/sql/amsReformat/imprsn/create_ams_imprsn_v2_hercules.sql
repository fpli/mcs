CREATE EXTERNAL TABLE im_tracking.ams_imprsn_v2 (
...
) PARTITIONED BY (`imprsn_dt` string)
ROW FORMAT SERDE
...
LOCATION 'hdfs://hercules/sys/edw/imk/im_tracking/epn/ams_imprsn_v2/snapshot';
