...
AlertingAggregation_v2 = SSHOperator(task_id='AlertingAggregation_v2',
                                  ssh_conn_id=ssh_conn_id,
                                  remote_host=remote_hosts,
                                  command='/datashare/mkttracking/tools/AlertingAggrate-tool-imk-v2/bin/alerting_aggregation_v2.sh ',
                                  dag=dag)
