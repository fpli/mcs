...
${apollo_command} dfs -rm -r viewfs://apollo-rno//apps/b_marketing_tracking/chocolate/epnnrt-new-test/imp/imprsn_dt=${date}
${apollo_command} dfs -rm -r viewfs://apollo-rno//apps/b_marketing_tracking/chocolate/epnnrt-old-test/imp/imprsn_dt=${date}
function createMeta() {
    channel=$1;
