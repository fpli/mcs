...
${SPARK_HOME}/bin/spark-submit  \
    ...
    /datashare/mkttracking/tools/AlertingAggrate-tool/lib/AlertingAggrate-tool_v2-*.jar hdfs://hercules/sys/edw/imk/im_tracking/epn/ams_click_v2/snapshot/ hdfs://hercules/apps/b_marketing_tracking/alert/epn/$DATE/dailyDomainTrend_v2 dailyDomainTrend yarn
