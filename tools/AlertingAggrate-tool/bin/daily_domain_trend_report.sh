...
hdfs dfs -rm -r hdfs://elvisha/apps/alert/epn/$DATE/dailyDomainTrend
...
${SPARK_HOME}/bin/spark-submit  \
    ...
    /datashare/mkttracking/tools/AlertingAggrate-tool/lib/AlertingAggrate-tool-3.4.2-RELEASE-fat.jar hdfs://elvisha/apps/epn-nrt/click/ hdfs://elvisha/apps/alert/epn/$DATE/dailyDomainTrend dailyDomainTrend df_epn_click.json yarn
