...
echo "DATE:${DATE}"
TMP_DIR="/datashare/mkttracking/tools/AlertingAggrate-tool/temp"
...
/datashare/mkttracking/tools/hercules_lvs/hadoop-hercules/bin/hdfs dfs -get hdfs://hercules/apps/b_marketing_tracking/alert/epn/$DATE3/hourlyClickCount/part-*.csv ${TMP_DIR}/hourly_click_count
...
/datashare/mkttracking/tools/apollo_rno/hadoop_apollo_rno/bin/hadoop fs -ls viewfs://apollo-rno/apps/b_marketing_tracking/chocolate/epnnrt/click/click_dt=$DATE4 | grep -v "^$" | awk '{print $6, $7, $8}' > ${TMP_DIR}/hourly_monitor_epn/today/file-apollorno-list.csv
/datashare/mkttracking/tools/apollo_rno/hadoop_apollo_rno/bin/hadoop fs -ls viewfs://apollo-rno/apps/b_marketing_tracking/chocolate/epnnrt/click/click_dt=$DATE5 | grep -v "^$" | awk '{print $6, $7, $8}' > ${TMP_DIR}/hourly_monitor_epn/yesterday/file-apollorno-list.csv
/datashare/mkttracking/tools/hercules_lvs/hadoop-hercules/bin/hadoop fs -ls hdfs://hercules/sys/edw/imk/im_tracking/epn/ams_click/snapshot/click_dt=$DATE4 | grep -v "^$" | awk '{print $6, $7, $8}' > ${TMP_DIR}/hourly_monitor_epn/today/file-herculeslvs-list.csv
/datashare/mkttracking/tools/hercules_lvs/hadoop-hercules/bin/hadoop fs -ls hdfs://hercules/sys/edw/imk/im_tracking/epn/ams_click/snapshot/click_dt=$DATE5 | grep -v "^$" | awk '{print $6, $7, $8}' > ${TMP_DIR}/hourly_monitor_epn/yesterday/file-herculeslvs-list.csv
DATE6=`date --date= +%Y%m%d`
DATE7=`date --date="1 days ago" +%Y%m%d`
/datashare/mkttracking/tools/apollo_rno/hadoop_apollo_rno/bin/hadoop fs -ls viewfs://apollo-rno/apps/b_marketing_tracking/watch/$DATE6 | grep -v "^$" | awk '{print $8}' | grep "ams_click_hourly" > ${TMP_DIR}/hourly_monitor_epn/today/donefile-apollorno-list.csv
/datashare/mkttracking/tools/apollo_rno/hadoop_apollo_rno/bin/hadoop fs -ls viewfs://apollo-rno/apps/b_marketing_tracking/watch/$DATE7 | grep -v "^$" | awk '{print $8}' | grep "ams_click_hourly" > ${TMP_DIR}/hourly_monitor_epn/yesterday/donefile-apollorno-list.csv
/datashare/mkttracking/tools/hercules_lvs/hadoop-hercules/bin/hadoop fs -ls hdfs://hercules/apps/b_marketing_tracking/watch/$DATE6 | grep -v "^$" | awk '{print $8}' | grep "ams_click_hourly" > ${TMP_DIR}/hourly_monitor_epn/today/donefile-herculeslvs-list.csv
/datashare/mkttracking/tools/hercules_lvs/hadoop-hercules/bin/hadoop fs -ls hdfs://hercules/apps/b_marketing_tracking/watch/$DATE7 | grep -v "^$" | awk '{print $8}' | grep "ams_click_hourly" > ${TMP_DIR}/hourly_monitor_epn/yesterday/donefile-herculeslvs-list.csv
...
/datashare/mkttracking/tools/apollo_rno/hadoop_apollo_rno/bin/hadoop fs -get viewfs://apollo-rno/apps/b_marketing_tracking/alert/imk/temp/hourlyClickCount/* ${TMP_DIR}/imk_hourly_count
...
java -cp /datashare/mkttracking/tools/AlertingAggrate-tool-imk-v2/lib_v1/AlertingAggrate-tool-*.jar com.ebay.traffic.chocolate.AAMain $DATE mx.vip.ebay.com lli5@ebay.com,zhofan@ebay.com,yliu29@ebay.com,shuangxu@ebay.com,jialili1@ebay.com,xiangli4@ebay.com,fechen@ebay.com,zhiyuawang@ebay.com,zjian@ebay.com,yyang28@ebay.com,yli19@ebay.com hourly
