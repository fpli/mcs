...
/datashare/mkttracking/tools/apollo_rno/hadoop_apollo_rno/bin/hadoop fs -ls viewfs://apollo-rno/apps/b_marketing_tracking/chocolate/epnnrt/click/click_dt=$DATE4 | grep -v "^$" | awk '{print $6, $7, $8}' > /datashare/mkttracking/tools/AlertingAggrate-tool/temp/hourly_monitor_epn/today/file-apollorno-list.csv
/datashare/mkttracking/tools/apollo_rno/hadoop_apollo_rno/bin/hadoop fs -ls viewfs://apollo-rno/apps/b_marketing_tracking/chocolate/epnnrt/click/click_dt=$DATE5 | grep -v "^$" | awk '{print $6, $7, $8}' > /datashare/mkttracking/tools/AlertingAggrate-tool/temp/hourly_monitor_epn/yesterday/file-apollorno-list.csv
/datashare/mkttracking/tools/hercules_lvs/hadoop-hercules/bin/hadoop fs -ls hdfs://hercules/sys/edw/imk/im_tracking/epn/ams_click/snapshot/click_dt=$DATE4 | grep -v "^$" | awk '{print $6, $7, $8}' > /datashare/mkttracking/tools/AlertingAggrate-tool/temp/hourly_monitor_epn/today/file-herculeslvs-list.csv
/datashare/mkttracking/tools/hercules_lvs/hadoop-hercules/bin/hadoop fs -ls hdfs://hercules/sys/edw/imk/im_tracking/epn/ams_click/snapshot/click_dt=$DATE5 | grep -v "^$" | awk '{print $6, $7, $8}' > /datashare/mkttracking/tools/AlertingAggrate-tool/temp/hourly_monitor_epn/yesterday/file-herculeslvs-list.csv
