...
${SPARK_HOME}/bin/spark-submit  \
    ...
    /datashare/mkttracking/tools/AlertingAggrate-tool/lib/AlertingAggrate-tool-*.jar hdfs://hercules/sys/edw/imk/im_tracking/epn/ams_click/snapshot/ hdfs://hercules/apps/b_marketing_tracking/alert/epn/$DATE/hourlyClickCount hourlyClickCount df_epn_click.json yarn
