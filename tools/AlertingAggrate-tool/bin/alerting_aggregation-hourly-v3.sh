...
echo "DATE:${DATE}"
TMP_DIR="/datashare/mkttracking/jobs/tools/AlertingAggrate-tool/temp"
...
cd /datashare/mkttracking/jobs/tools/AlertingAggrate-tool/lib
java -cp ./AlertingAggrate-tool-*.jar com.ebay.traffic.chocolate.AAMain $DATE mx.vip.ebay.com Marketing-Tracking-oncall@ebay.com,DL-eBay-Chocolate-GC@ebay.com hourly $CLUSTER
