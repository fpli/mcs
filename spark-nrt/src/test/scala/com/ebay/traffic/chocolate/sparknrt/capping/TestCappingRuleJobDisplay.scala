...
/**
  ...
  */
class TestCappingRuleJobDisplay extends BaseFunSuite {
  ...
  test("test display capping rules") {
    ...
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 2L, 11L, 111L, timestamp1, "1.1.1.1", cguid1, writer1_1)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 3L, 11L, 111L, timestamp1, "1.1.1.2", cguid2, writer1_1)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 4L, 11L, 111L, timestamp1, "1.1.1.2", cguid2, writer1_2)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 5L, 11L, 111L, timestamp2, "1.1.1.2", cguid2, writer1_2)

    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 6L, 11L, 111L, timestamp2, "1.1.1.1", cguid1, writer2_1)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 7L, 11L, 111L, timestamp2, "1.1.1.2", cguid2,  writer2_1)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 8L, 11L, 111L, timestamp2, "1.1.1.2", cguid2, writer2_2)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 9L, 22L, 111L, timestamp2, "1.1.1.3", cguid3, writer2_2)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 10L, 11L, 111L, timestamp2, "1.1.1.3", cguid3, writer2_2)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 11L, 11L, 111L, timestamp2, "1.1.1.3", cguid3, writer2_2)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 12L, 11L, 111L, timestamp2, "1.1.1.3", cguid3, writer2_2)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 13L, 11L, 111L, timestamp2, "1.1.1.3", cguid3, writer2_2)

    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.CLICK, 14L, 11L, 111L, timestamp2, "1.1.1.2", cguid2, writer3)
    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.IMPRESSION, 15L, 11L, 111L, timestamp2, "1.1.1.2", cguid2, writer3)

    writeFilterMessage(ChannelType.DISPLAY, ChannelAction.IMPRESSION, 16L, 11L, 111L, timestamp3, "1.1.1.2", cguid2, writer4)
