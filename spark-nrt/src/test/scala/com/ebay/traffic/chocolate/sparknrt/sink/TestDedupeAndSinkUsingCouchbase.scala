 ...
 * @author xiangli4
 */
class TestDedupeAndSinkUsingCouchbase extends BaseFunSuite {
  ...
  def sendFilterMessage(snapshotId: Long, shortSnapshotId: Long, publisherId: Long, campaignId: Long, date: String):
  FilterMessage = {
