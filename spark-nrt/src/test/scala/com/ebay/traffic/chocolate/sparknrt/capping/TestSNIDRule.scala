...
import com.ebay.traffic.chocolate.sparknrt.capping.rules.SNIDRule
...
/**
  ...
  */
class TestSNIDRule extends BaseFunSuite {
  ...
  test("test snid capping rule long") {
    ...
    val job_0 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_L), dateFiles_0, sparkJob, windowLong)
    val df_0 = job_0.test()
    df_0.show()
    ...
    val job_1 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_L), dateFiles_1, sparkJob, windowLong)
    val df_1 = job_1.test()
    df_1.show()
    ...
    val job_2 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_L), dateFiles_2, sparkJob, windowLong)
    val df_2 = job_2.test()
    df_2.show()
    ...
    val job_3 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_L), dateFiles_3, sparkJob, windowLong)
    val df_3 = job_3.test()
    df_3.show()
  ...
  test("test snid capping rule short") {
    ...
    val job_4 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_S), dateFiles_4, sparkJob, windowShort)
    val df_4 = job_4.test()
    df_4.show()
    ...
    val job_5 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_S), dateFiles_5, sparkJob, windowShort)
    val df_5 = job_5.test()
    df_5.show()
    ...
    val job_6 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_S), dateFiles_6, sparkJob, windowShort)
    val df_6 = job_6.test()
    df_6.show()
    ...
    val writer7 = AvroParquetWriter.
      ...
      .withCompressionCodec(CompressionCodecName.SNAPPY)
      .build()
    // currently not able to handle cross day snid short
    // as we use first click's timestamp - timewindow to get previous data
    ...
    val job_7 = new SNIDRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_S), dateFiles_7, sparkJob, windowShort)
    val df_7 = job_7.test()
    df_7.show()
    assert(df_7.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.SnidCappingRule_S)).=!=(0)).count() == 1)
    job_7.postTest()
