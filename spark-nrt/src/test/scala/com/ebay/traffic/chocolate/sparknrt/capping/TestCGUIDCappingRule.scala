...
import com.ebay.traffic.chocolate.sparknrt.capping.rules.CGUIDCappingRule
...
class TestCGUIDCappingRule extends BaseFunSuite {
  ...
  ignore("test cguid capping rule") {
    ...
    df_01.show()
    df_02.show()
    assert(df_01.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S)).=!=(0)).count() == 0)
    assert(df_02.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L)).=!=(0)).count() == 0)
    job_01.postTest()
    job_02.postTest()
    ...
    writeFilterMessage(ChannelType.EPN, ChannelAction.CLICK, 14L, 11L, 111L, cguid3, timestamp3, writer3)

    writeFilterMessage(ChannelType.EPN, ChannelAction.IMPRESSION, 15L, 11L, 111L, cguid2, timestamp4, writer4)
    ...
    val job_11 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S), dateFiles_1, sparkJob, windowShort)
    val job_12 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L), dateFiles_1, sparkJob, windowLong)
    val df_11 = job_11.test()
    val df_12 = job_12.test()
    df_11.show()
    df_12.show()
    assert(df_11.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S)).=!=(0)).count() == 0)
    assert(df_12.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L)).=!=(0)).count() == 0)
    job_11.postTest()
    job_12.postTest()
    ...
    val job_21 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S), dateFiles_2, sparkJob, windowShort)
    val job_22 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L), dateFiles_2, sparkJob, windowLong)
    val df_21 = job_21.test()
    val df_22 = job_22.test()
    df_21.show()
    df_22.show()
    assert(df_21.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S)).=!=(0)).count() == 2)
    assert(df_22.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L)).=!=(0)).count() == 2)
    job_21.postTest()
    job_22.postTest()
    ...
    val job_31 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S), dateFiles_3, sparkJob, windowShort)
    val job_32 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L), dateFiles_3, sparkJob, windowLong)
    val df_31 = job_31.test()
    val df_32 = job_32.test()
    df_31.show()
    df_32.show()
    assert(df_31.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S)).=!=(0)).count() == 0)
    assert(df_32.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L)).=!=(0)).count() == 2)
    job_31.postTest()
    job_32.postTest()
    ...
    val job_41 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S), dateFiles_4, sparkJob, windowShort)
    val job_42 = new CGUIDCappingRule(params, CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L), dateFiles_4, sparkJob, windowLong)
    val df_41 = job_41.test()
    val df_42 = job_42.test()
    df_41.show()
    df_42.show()
    assert(df_41.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_S)).=!=(0)).count() == 0)
    assert(df_42.filter($"capping".bitwiseAND(CappingRuleEnum.getBitValue(CappingRuleEnum.CGUIDCappingRule_L)).=!=(0)).count() == 0)
    job_41.postTest()
    job_42.postTest()
  }
}
