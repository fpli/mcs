...
class TestEpnNrtJob extends BaseFunSuite{
  ...
  def createTestDataForEPN(): Unit = {
    ...
    // Desktop
    writeFilterMessage(ChannelType.EPN, ChannelAction.CLICK, 6457493984045429247L, -1L, -1L, "76cbd9ea15b0a93d12831833fff1c1065ad49dd7^", timestamp - 12, writer1)
    writeFilterMessage(ChannelType.EPN, ChannelAction.CLICK, 1109090984045429247L, -1L, -1L, "12cbd9iqoiwjddwswdwdwa33fff1c1065ad49dd7^", timestamp - 12, writer1)

    writeFilterMessage(ChannelType.EPN, ChannelAction.IMPRESSION, 7817281212121239247L, -1L, -1L, "34cbd9iqoiwjddws09ydwa33fff1c1065ad49dd7^", timestamp - 8, writer1)
    writeFilterMessage(ChannelType.EPN, ChannelAction.IMPRESSION, 2902129817128329247L, -1L, -1L, "56cbd9iqoiwjddwswdwdwa33fff1c1065ad49dd7^", timestamp - 7,  writer1)
    writer1.close()

    writeFilterMessage(ChannelType.EPN, ChannelAction.CLICK, 6457493984045429247L, -1L, -1L, "76cbd9ea15b0a93d12831833fff1c1065ad49dd7^", timestamp - 12, writer2)
    writeFilterMessage(ChannelType.EPN, ChannelAction.CLICK, 1109090984045429247L, -1L, -1L, "12cbd9iqoiwjddwswdwdwa33fff1c1065ad49dd7^", timestamp - 12, writer2)

    writeFilterMessage(ChannelType.EPN, ChannelAction.IMPRESSION, 7817281212121239247L, -1L, -1L, "34cbd9iqoiwjddws09ydwa33fff1c1065ad49dd7^", timestamp - 8, writer2)
    writeFilterMessage(ChannelType.EPN, ChannelAction.IMPRESSION, 2902129817128329247L, -1L, -1L, "56cbd9iqoiwjddwswdwdwa33fff1c1065ad49dd7^", timestamp - 7,  writer2)
    writer2.close()

    writeFilterMessage(ChannelType.EPN, ChannelAction.CLICK, 6457493984045429247L, -1L, -1L, "76cbd9ea15b0a93d12831833fff1c1065ad49dd7^", timestamp - 12, writer3)
    writeFilterMessage(ChannelType.EPN, ChannelAction.CLICK, 1109090984045429247L, -1L, -1L, "12cbd9iqoiwjddwswdwdwa33fff1c1065ad49dd7^", timestamp - 12, writer3)

    writeFilterMessage(ChannelType.EPN, ChannelAction.IMPRESSION, 7817281212121239247L, -1L, -1L, "34cbd9iqoiwjddws09ydwa33fff1c1065ad49dd7^", timestamp - 8, writer3)
    writeFilterMessage(ChannelType.EPN, ChannelAction.IMPRESSION, 2902129817128329247L, -1L, -1L, "56cbd9iqoiwjddwswdwdwa33fff1c1065ad49dd7^", timestamp - 7,  writer3)
    writer3.close()
