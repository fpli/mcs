...
class TestBullseyeUtilsV2 extends FlatSpec with Matchers{
  ...
  "can parse response correctly" must "work" in {
    ...
    val results = BullseyeUtilsV2.getLastViewItemByResponse("1555292153683", mockResponse)
  ...
  "can parse response correctly to filter null result" must "work" in {
    ...
    val mockResponse = HttpResponse(response, 200, Map())
    val results = BullseyeUtilsV2.getLastViewItemByResponse("1555292249113", mockResponse)
  ...
  "can parse multiple response correctly" must "work" in {
    ...
    val mockResponse = HttpResponse(response, 200, Map())
    val results = BullseyeUtilsV2.getLastViewItemByResponse("1555290059224", mockResponse)
