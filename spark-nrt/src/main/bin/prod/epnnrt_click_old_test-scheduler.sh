...
/datashare/mkttracking/jobs/tracking/epnnrt_v2/bin/prod/distcpAmsToRenoAndHercules.sh /apps/epn-nrt/click_old_test /apps/b_marketing_tracking/chocolate/epnnrt-old-test/click /sys/edw/imk/im_tracking/epn_old_test/ams_click/snapshot click
