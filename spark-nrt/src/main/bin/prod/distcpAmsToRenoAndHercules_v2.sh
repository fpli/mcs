...
usage="Usage: distcpAmsToRenoAndHercules_v2.sh [metaDir] [renoDestDir] [herculesDestDir] [type]"
...
META_PATH="hdfs://slickha${META_DIR}/date=${yesterday}"
...
epn_output_path="hdfs://slickha/apps/tracking-events-workdir-v2/meta/EPN/output"
if [ "${TYPE}" == "click" ]
then
