...
function start_job(){
    ...
    echo $hdfs
    /datashare/mkttracking/jobs/tracking/sparknrt/bin/prod/cappingRule.sh DISPLAY $hdfs/apps/tracking-events-workdir $hdfs/apps/tracking-events $hdfs/apps/tracking-events-archiveDir 150 http://chocolateclusteres-app-private-11.stratus.lvs.ebay.com:9200
EOSSH
}
