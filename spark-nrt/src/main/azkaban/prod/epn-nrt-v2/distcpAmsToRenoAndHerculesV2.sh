...
function start_job(){
    ...
    ./distcpAmsToRenoAndHercules.sh /apps/epn-nrt/click_v2 /apps/b_marketing_tracking/chocolate/epnnrt/click_v2 /sys/edw/imk/im_tracking/epn/ams_click_v2/snapshot click &&
    ./distcpAmsToRenoAndHercules.sh /apps/epn-nrt/impression_v2 /apps/b_marketing_tracking/chocolate/epnnrt/imprsn_v2 /sys/edw/imk/im_tracking/epn/ams_impression_v2/snapshot imp
EOSSH
}
