...
function start_job(){
    ...
    ./putImkHourlyDoneToRenoAndHerculesNew.sh /apps/tracking-events/watch /datashare/mkttracking/jobs/chocolate-sparknrt/bin/prod/temp_put_imk_hourly_done_to_reno_and_hercules /apps/b_marketing_tracking/watch /apps/b_marketing_tracking/watch
EOSSH
}
