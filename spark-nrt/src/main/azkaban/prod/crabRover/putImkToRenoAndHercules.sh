...
function start_job(){
    ...
    ./putImkToRenoAndHercules.sh /apps/tracking-events/crabTransform/mgOutput /apps/b_marketing_tracking/imk_tracking/imk_scp_middle/imk_rvr_trckng_event_mg /apps/b_marketing_tracking/imk_tracking/imk_rvr_trckng_event_mg /datashare/mkttracking/work/imkToReno/crab/mgTemp /apps/b_marketing_tracking/IMK_RVR_TRCKNG_EVENT/imk_rvr_trckng_event_mg &&
    ./putImkToRenoAndHercules.sh /apps/tracking-events/imkTransform/mgOutput /apps/b_marketing_tracking/imk_tracking/imk_scp_middle/imk_rvr_trckng_event_mg /apps/b_marketing_tracking/imk_tracking/imk_rvr_trckng_event_mg /datashare/mkttracking/work/imkToReno/imk/mgTemp /apps/b_marketing_tracking/IMK_RVR_TRCKNG_EVENT/imk_rvr_trckng_event_mg
EOSSH
}
