...
./scpDataToETLByMeta.sh /apps/tracking-events-workdir DISPLAY imkDump meta.etl /datashare/mkttracking/rsa/panda_id_rsa etl_panda_push@lvsdpeetl012.lvs.ebay.com:/dw/etl/home/prod/land/dw_dfe/rvr_test YES NO
EOSSH
