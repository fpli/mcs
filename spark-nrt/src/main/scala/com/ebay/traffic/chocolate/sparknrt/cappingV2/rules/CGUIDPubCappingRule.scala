package com.ebay.traffic.chocolate.sparknrt.cappingV2.rules

import com.ebay.traffic.chocolate.spark.BaseSparkJob
import com.ebay.traffic.chocolate.sparknrt.cappingV2.ParameterV2
...
/**
  ...
  */
class CGUIDPubCappingRule(params: ParameterV2, bit: Long, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window: String)
    extends GenericCountRule(params: ParameterV2, bit: Long, dateFiles: DateFiles,  cappingRuleJobObj: BaseSparkJob, window: String) {

  import cappingRuleJobObj.spark.implicits._

  //workdir
  override lazy val fileName = "/guidPub_" + window + "/"
  //specific columns for CGUIDPub Capping Rule
  override val cols = Array(col("GUID"), col("publisher_id"))
