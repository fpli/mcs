...
class SNIDCappingRule(params: Parameter_v2, bitLong: Long, bitShort: Long, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window: String)
  extends GenericRule(params: Parameter_v2, bitLong, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window) with Serializable {
