...
class EpnNrtCommonV2(params: ParameterV2, df: DataFrame) extends Serializable {
  ...
  def getLastViewItemInfo(cguid: String, timestamp: String): Array[String] = {
    val res = BullseyeUtilsV2.getLastViewItem(cguid, timestamp, properties.getProperty("epnnrt.modelId"), properties.getProperty("epnnrt.lastviewitemnum"), properties.getProperty("epnnrt.bullseyeUrl"))
    Array(res._1, res._2)
  }

  def getLastViewItemInfoV3(cguid: String, guid: String, timestamp: String): Array[String] = {
    val res = BullseyeUtilsV2.getLastViewItemV3(cguid, guid, timestamp, properties.getProperty("epnnrt.modelId"), properties.getProperty("epnnrt.lastviewitemnum"), properties.getProperty("epnnrt.bullseyeUrlV3"))
    Array(res._1, res._2)
  }
