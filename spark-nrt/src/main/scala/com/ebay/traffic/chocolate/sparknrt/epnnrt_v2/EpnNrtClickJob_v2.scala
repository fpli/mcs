    ...
    cappingMeta.foreach(metaIter => {
      ...
      datesFiles.foreach(datesFile => {
        ...
        breakable {
          ...
          metrics.meterByGauge("DateFileCount_tess", size,  Field.of[String, AnyRef]("channelAction", "CLICK"))
          metrics.meterByGauge("InComingCount_tess", df.count(),  Field.of[String, AnyRef]("channelAction", "CLICK"))
          ...
          if (debug) {
            ...
            metrics.meterByGauge("ClickFilterCount_tess", df_click_count_before_filter - df_click_count_after_filter)
          }
          ...
          metrics.meterByGauge("SuccessfulCount_tess", countClickDf.count(),  Field.of[String, AnyRef]("channelAction", "CLICK"))
          ...
          retry(3) {
            ...
            metrics.meterByGauge("OutputMetaSuccessful_tess", params.partitions * 2, Field.of[String, AnyRef]("channelAction", "CLICK"))
      ...
      metrics.meterByGauge("MetaFileCount_tess", 1,  Field.of[String, AnyRef]("channelAction", "CLICK"))
