      ...
      datesFiles.foreach(datesFile => {
        ...
        breakable {
          ...
          try {
            ...
            metadata.writeOutputMeta(imp_metaFile, properties.getProperty("epnnrt.scp.meta.imp.outputdir"), "epnnrt_scp_imp", Array(".epnnrt_etl", ".epnnrt_reno", ".epnnrt_hercules", ".epnnrt_summary"))
          ...
          try {
            ...
            //write meta file for EPN SCP job to copy result to ETL and reno
            metadata.writeOutputMeta(click_metaFile, properties.getProperty("epnnrt.scp.meta.click.outputdir"), "epnnrt_scp_click", Array(".epnnrt_etl", ".epnnrt_reno", ".epnnrt_hercules", ".epnnrt_summary"))
