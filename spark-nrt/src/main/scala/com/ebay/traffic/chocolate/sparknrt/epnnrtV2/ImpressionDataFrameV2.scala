...
class ImpressionDataFrameV2(df: DataFrame, common: EpnNrtCommonV2) extends Serializable {
  ...
  def build(): DataFrame = {
    ...
    var impressionDf = df
      ...
      .withColumn("USER_QUERY_TXT", common.filterTab(common.getUserQueryTextUdf(col("uri"), lit("impression"))))
      ...
      .withColumn("FLEX_FLD_6_TXT",  common.filterTab(common.getFFValueUdf(col("uri"), lit(6))))
      .withColumn("FLEX_FLD_7_TXT",  common.getFFValueUdf(col("uri"), lit(7)))
      .withColumn("FLEX_FLD_8_TXT",  common.getFFValueUdf(col("uri"), lit(8)))
      .withColumn("FLEX_FLD_9_TXT",  common.filterTab(common.getFFValueUdf(col("uri"), lit(9))))
      ...
      .withColumn("AD_FORMAT", common.filterTab(common.get_ad_format_Udf(col("uri"))))
      .withColumn("AD_CONTENT_TYPE", common.filterTab(common.get_ad_content_type_Udf(col("uri"))))
