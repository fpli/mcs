    ...
    if (params.cappingMetrics) {
      ...
      if (head.length == 0) {
        ...
        if (metrics != null) {
          ...
          metrics.meter("IPPubShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.IPPubCappingRule_S, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("IPPubShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.IPPubCappingRule_S, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.meter("IPPubLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.IPPubCappingRule_L, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("IPPubLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.IPPubCappingRule_L, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.meter("CGUIDShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDCappingRule_S, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("CGUIDShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDCappingRule_S, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.meter("CGUIDLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDCappingRule_L, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("CGUIDLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDCappingRule_L, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.meter("CGUIDPubShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDPubCappingRule_S, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("CGUIDPubShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDPubCappingRule_S, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.meter("CGUIDPubLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDPubCappingRule_L, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("CGUIDPubLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.CGUIDPubCappingRule_L, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.meter("SnidShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.SnidCappingRule_S, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("SnidShortCappingCount", CappingCount(dfMetrics, CappingRuleEnum.SnidCappingRule_S, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.meter("SnidLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.SnidCappingRule_L, "CLICK", "EPN"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "EPN"))
          metrics.meter("SnidLongCappingCount", CappingCount(dfMetrics, CappingRuleEnum.SnidCappingRule_L, "CLICK", "DISPLAY"), eventTime, Field.of("channelAction", "CLICK"), Field.of("channelType", "DISPLAY"))
          metrics.flush()
        }
      }
    }
