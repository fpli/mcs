...
import com.ebay.traffic.chocolate.sparknrt.cappingV2.{CappingRuleV2, ParameterV2}
...
/**
  ...
  */
abstract class GenericRule(params: ParameterV2, bit: Long, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window: String)
  extends CappingRuleV2 with Serializable {
