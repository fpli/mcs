package com.ebay.traffic.chocolate.sparknrt.sink_listener_v2
...
object DedupeAndSinkListener_v2 extends App {
  override def main(args: Array[String]) = {
    val params = Parameter_v2(args)

    val job = new DedupeAndSinkListener_v2(params)

    job.run()
    job.stop()
  }
}
class DedupeAndSinkListener_v2(params: Parameter_v2)
  ...
  override def run() = {
    ...
    val kafkaRDD = new KafkaRDD_v2[lang.Long, ListenerMessage](
