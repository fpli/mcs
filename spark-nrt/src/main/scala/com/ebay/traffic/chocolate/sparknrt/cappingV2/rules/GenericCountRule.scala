...
/**
  ...
  */
abstract class GenericCountRule(params: ParameterV2, bit: Long, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window: String)
  extends GenericRule(params: ParameterV2, bit: Long, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window: String){
