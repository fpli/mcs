...
object EpnNrtImpressionJobV2 extends App {
...
class EpnNrtImpressionJobV2(params: ParameterV2) extends BaseEpnNrtJobV2(params, params.appName, params.mode) {
    ...
    cappingMeta.foreach(metaIter => {
      ...
      datesFiles.foreach(datesFile => {
        ...
        breakable {
          ...
          metrics.meterByGauge("DateFileCountTess", size,  Field.of[String, AnyRef]("channelAction", "IMPRESSION"))
          metrics.meterByGauge("InComingCountTess", df.count(),  Field.of[String, AnyRef]("channelAction", "IMPRESSION"))
          ...
          if (debug) {
            ...
            metrics.meterByGauge("ImpressionFilterCountTess", df_impression_count_before_filter - df_impression_count_after_filter)
          }

          //3. build impression dataframe  save dataframe to files and rename files
          var impressionDf = new ImpressionDataFrameV2(df_impression, epnNrtCommon).build()
          ...
          metrics.meterByGauge("SuccessfulCountTess", countImpDf.count(), Field.of[String, AnyRef]("channelAction", "IMPRESSION"))
      ...
      metrics.meterByGauge("MetaFileCountTess", 1,  Field.of[String, AnyRef]("channelAction", "IMPRESSION"))
