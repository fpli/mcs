...
/**
  ...
  */
case class Parameter(appName: String = "DedupeAndSinkListener",
                     mode: String = "yarn",
                     channel: String = "",
                     kafkaTopic: String = "",
                     workDir: String = "",
...
object Parameter {
  ...
  private lazy val parser = new OptionParser[Parameter]("DedupeAndSinkListener") {
    head("DedupeAndSinkListener")
