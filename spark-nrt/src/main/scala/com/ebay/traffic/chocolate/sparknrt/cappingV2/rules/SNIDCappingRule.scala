...
class SNIDCappingRule(params: ParameterV2, bitLong: Long, bitShort: Long, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window: String)
  extends GenericRule(params: ParameterV2, bitLong, dateFiles: DateFiles, cappingRuleJobObj: BaseSparkJob, window) with Serializable {
