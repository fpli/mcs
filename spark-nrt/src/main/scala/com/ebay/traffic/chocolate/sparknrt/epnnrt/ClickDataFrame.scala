...
class ClickDataFrame(df: DataFrame, common: EpnNrtCommon) extends Serializable {
  ...
  def build(): DataFrame = {
    var clickDf  = df.withColumn("IMPRSN_CNTNR_ID", lit(""))
      ...
      .withColumn("AMS_CLICK_FLTR_TYPE_ID", common.get_ams_clk_fltr_type_id_udf(col("publisher_id")))
      ...
      .withColumn("AMS_TRANS_RSN_CD", common.get_click_reason_code_udf(col("uri"), col("publisher_id"), col("campaign_id"), col("rt_rule_flags"), col("nrt_rule_flags")))
      ...
      .withColumn("ROI_FLTR_YN_IND", common.get_roi_fltr_yn_ind_udf(col("uri"), col("publisher_id"), col("request_headers")))
      ...
      .withColumn("TRFC_SRC_CD",  common.get_trfc_src_cd_click_udf(col("rt_rule_flags")))
      .withColumn("ROI_RULE_VALUE",  common.get_roi_rule_value_udf(col("uri"), col("publisher_id"), col("request_headers")))
