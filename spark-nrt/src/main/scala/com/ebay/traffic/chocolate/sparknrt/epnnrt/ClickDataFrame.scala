...
class ClickDataFrame(df: DataFrame, common: EpnNrtCommon) extends Serializable {
  ...
  def build(): DataFrame = {
    var clickDf  = df
      ...
      .withColumn("GEO_TRGTD_IND", lit(0))
      .withColumn("PBLSHR_ACPTD_PRGRM_IND", lit(0))
      ...
      .withColumn("PRGRM_EXCPTN_LIST_IND", lit(0))
      ...
      .withColumn("ROI_RULE_VALUE",  common.get_roi_rule_value_udf(col("uri"), col("publisher_id"), col("request_headers"), col("google_fltr_do_flag"), col("traffic_source_code")))
