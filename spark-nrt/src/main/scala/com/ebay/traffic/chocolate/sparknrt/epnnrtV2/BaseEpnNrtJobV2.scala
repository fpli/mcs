...
import com.ebay.traffic.chocolate.sparknrt.BaseSparkNrtJobV2
...
/**
  ...
  */
abstract class BaseEpnNrtJobV2(params: ParameterV2,
                               override val jobName: String,
                               override val mode: String = "yarn") extends BaseSparkNrtJobV2(jobName, mode) {
