 ...
 */
public class KafkaSink2 {
  private static final Logger LOG = Logger.getLogger(KafkaSink2.class);
   ...
   */
  public static <K, V> Producer<K, V> get() {
    synchronized (KafkaSink2.class) {
      if (producer == null) {
