...
public class DefaultChannelTest {
  ...
  public void processRoverSyncCommand() throws Exception{
    ...
    when(mockMessageParser.getGuid(any(), eq(setCookie), null, eq("cguid"))).thenReturn("758674e91690a99b9634d24de79bcaad");
    when(mockMessageParser.getGuid(any(), eq(setCookie), null, eq("tguid"))).thenReturn("75866c251690ab6af110f0bffffdb253");
    channel.process(mockClientRequest, mockProxyResponse);
    Thread.sleep(3000);
