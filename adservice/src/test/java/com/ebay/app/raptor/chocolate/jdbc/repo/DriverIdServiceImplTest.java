...
public class DriverIdServiceImplTest extends TestCase {
    ...
    public void testIllegalArgumentException() {
        ...
        thrown.expectMessage("cannot generate a new driver id!");
        driverIdService.getDriverId("test-host-1", "test-ip-1", 2, 0);
    ...
    public void testIllegalArgumentException1() {
        ...
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("all driver ids are in use!");
        driverIdService.getDriverId("test-host-3", "test-ip-3", 2, 1);
