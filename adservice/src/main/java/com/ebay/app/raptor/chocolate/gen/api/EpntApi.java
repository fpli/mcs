...
public interface EpntApi {
    ...
    Response placement(@QueryParam("st") @ApiParam("ePN campaign status") String st,
                       ...
                       @QueryParam("pid") @ApiParam("Placement ID to recognize") String pid,
                       @QueryParam("ad_v") @ApiParam("Must be 1 or 2. 1 is deprecated. 2 means the advertisement is rendered in DS6 style") String ad_v);
}
