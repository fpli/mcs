...
public class Errors {
  ...
  static {
    errorMap.put(ERROR_NO_USER_AGENT, new ErrorType(4000, ERROR_NO_USER_AGENT, "No User-Agent found."));
    errorMap.put(ERROR_NO_ENDUSERCTX, new ErrorType(4001, ERROR_NO_ENDUSERCTX, "No X-EBAY-C-ENDUSERCTX header."));
    errorMap.put(ERROR_NO_TRACKING, new ErrorType(4002, ERROR_NO_TRACKING, "No X-EBAY-C-TRACKING header."));
    errorMap.put(ERROR_NO_REFERER, new ErrorType(4003, ERROR_NO_REFERER, "No Referer in header nor in post body."));
    errorMap.put(ERROR_ILLEGAL_URL, new ErrorType(4004, ERROR_ILLEGAL_URL, "Illegal url format."));
    errorMap.put(ERROR_NO_QUERY_PARAMETER, new ErrorType(4005, ERROR_NO_QUERY_PARAMETER, "No query parameter."));
    errorMap.put(ERROR_NO_MKEVT, new ErrorType(4006, ERROR_NO_MKEVT, "No mkevt."));
    errorMap.put(ERROR_INVALID_MKEVT, new ErrorType(4007, ERROR_INVALID_MKEVT, "Invalid mkevt value."));
    errorMap.put(ERROR_INVALID_ENDUSERCTX, new ErrorType(4008, ERROR_INVALID_ENDUSERCTX, "Invalid X-EBAY-C-ENDUSERCTX header."));
    errorMap.put(ERROR_INTERNAL_SERVICE, new ErrorType(5000, ERROR_INTERNAL_SERVICE, "Internal Service Error."));
  }
}
