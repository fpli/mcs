...
public class RedirectContext {
  ...
  public URI execute(HttpServletRequest request, HttpServletResponse response, CookieReader cookie, ContainerRequestContext context) throws IOException, URISyntaxException {
      return strategy.process(request, response, cookie, context);
  }
}
