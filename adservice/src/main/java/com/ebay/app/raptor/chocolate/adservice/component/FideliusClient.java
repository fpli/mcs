...
import com.ebay.app.raptor.chocolate.adservice.model.request.FideliusRequest;
...
public class FideliusClient {
    private static final String URI_OBJECTS = "/objects/adservice/";
    ...
    public void create(String path, String secret) {
        ...
        Response response = webTarget.path(URI_OBJECTS + path).request()
                .header(HttpHeaders.AUTHORIZATION, getTfToken()).put(Entity.entity(fideliusRequest, MediaType.APPLICATION_JSON));
        checkError(response);
    }
